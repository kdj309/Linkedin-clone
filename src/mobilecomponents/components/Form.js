...
export default function Form() {
    ...
    return (
        <div style={{ backgroundColor: "white", width: "90%", margin: "auto", padding: "0.5em 1.6em" }} >
            {
            ...
            <button type="button" onClick={GoogleSignin} className="btn btn-primary" style={{ backgroundColor: "white", color: "#0073b1", width: "100%", borderRadius: "24px" }}>Join with Google</button>
            <hr></hr>
